...
public class Permission extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(Permission.this, Manifest.permission.ACCESS_FINE_LOCATION)== PackageManager.PERMISSION_GRANTED){
            startActivity(new Intent(Permission.this, GoogleMapsFragment.class));
            finish();
            return;
        }
        grentPermission=findViewById(R.id.allowPermission);
        grentPermission.setOnClickListener(new View.OnClickListener() {
            @Override
                        ...
                        .withListener(new PermissionListener() {
                            ...
                            public void onPermissionDenied(PermissionDeniedResponse permissionDeniedResponse) {
                                if (permissionDeniedResponse.isPermanentlyDenied())
                                {
                                    ...
                                    builder.setTitle("Permission Denied").setMessage("Permission is permanently denied ,go to settings to allow permission ")
