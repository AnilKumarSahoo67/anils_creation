...
public class EPSON_ListAdapter extends AppCompatActivity implements AdapterView.OnItemClickListener , View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_e_p_s_o_n__list_adapter);
        mContext = this;
        ...
        mPrinterListAdapter = new SimpleAdapter(this, mPrinterList, R.layout.list_for_printer,
                new String[] { "PrinterName", "Target" },
                new int[] { R.id.PrinterName, R.id.Target });
        ListView list = (ListView)findViewById(R.id.list_printer);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        HashMap<String,String> map=mPrinterList.get(position);
